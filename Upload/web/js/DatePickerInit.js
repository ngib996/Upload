...
OC = function () {
    ...
    return{
        ...
        initDatePicker: function () {
            ...
            if ($.datepicker.regional[OC.getLocale(4)] != undefined) {
                $.datepicker.setDefaults($.datepicker.regional[OC.getLocale(4)]);
            } else if ($.datepicker.regional[OC.getLocale(2)] != undefined) {
                $.datepicker.setDefaults($.datepicker.regional[OC.getLocale(2) ]);
            } else {
                $.datepicker.setDefaults($.datepicker.regional['']);
            }

            $('.JCVDatePicker').each(function () {
